...
include "connectionDB.php"; ?>
  <table class ="daftar-member" width="900" border="1" cellspacing="1" cellpadding="2 ">
      <tr >
          ...
          <?php
          $i = 0;
          $result = mysqli_query($con, "SELECT id, username_pk, isi 
                                        from account1, message 
                                        where account1.username = message.username_pk");
          ...
          <tr>
            ...
            <td><?php print $m['username_pk']; ?></td>
            <td><?php print $m['isi']; ?></td>
          </tr>    
        <?php
        }
        ?>  
