          ...
          ?>
                    ...
                    <div class="col-lg-4 col-md-4 all des">
                      <div class="product-item">
                        <img src="assets/images/<?php print $m['image']; ?>">
                        <div class="down-content">
                          <h4><?php print $m['name_product']; ?></h4>
                          <h6>Rp <?php print $m['price']; ?></h6>
                          ...
                          <ul class="stars">
                            ...
                            <li><i class="fa fa-star"></i></li>
                            <li><i class="fa fa-star"></i></li>
                            <ul><input type="button" class="btn btn-primary" value="Add to Cart"></ul>
                          </ul>
